...
export const BUDGET_CATEGORIES = [
  ...
  { category: 'Transport', minPercent: 8, maxPercent: 15, notes: 'Fuel, public transport, insurance' },
  ...
  { category: 'Children & Education', minPercent: 3, maxPercent: 10, notes: 'Childcare, school, supplies' },
  ...
  { category: 'Utilities', minPercent: 3, maxPercent: 6, notes: 'Electricity, gas, water, internet' },
