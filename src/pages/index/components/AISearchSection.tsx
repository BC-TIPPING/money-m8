    ...
    <div className="w-full max-w-4xl mx-auto mb-8 px-4">
      <div className="text-center mb-6">
        ...
        <p className="text-white/80 text-lg">
          Get expert advice based on ATO guidelines, Australian banking regulations, and Barefoot Investor principles
        </p>
      </div>
        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              placeholder="e.g., How much super should I have at 30? What's the best home loan strategy?"
