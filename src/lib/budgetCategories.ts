export const BUDGET_CATEGORIES = [
  { category: 'Housing (Rent/Mortgage)', minPercent: 25, maxPercent: 35, notes: 'Rent, mortgage, or house payments' },
  ...
  { category: 'Transport', minPercent: 5, maxPercent: 10, notes: 'Fuel, public transport, car insurance' },
  ...
  { category: 'Savings & Investments', minPercent: 5, maxPercent: 15, notes: 'Emergency fund, super, investing' },
